...
La nota de cada es RA es calcula a partir de la nota ponderada de les diferents unitats o actictats d'ensenyament-aprenentatge sempre i quan la nota de cada unitat sigui igual o superior a 5. Aquesta qualificació conjunta suposa un 70% de la nota. Un 30% de la nota correspon a les competències personals per la ocupabilitat (CPO).
